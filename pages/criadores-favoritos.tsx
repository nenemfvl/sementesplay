                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                   {criadoresFavoritos.map((criador) => (
                    <div 
                      ...
                      onClick={() => router.push(`/criador/${criador.id}`)}
                    >
                      <div className="flex">
                        {/* Conteúdo Principal */}
                        <div className="flex items-center flex-1">
                          <img 
                            ...
                            alt={criador.nome} 
                            className="w-12 h-12 rounded-full border-2 border-blue-400 mr-3 group-hover:border-sss-accent transition-colors" 
                          />
                          <div className="flex-1">
                            <div className="font-bold text-sss-white group-hover:text-sss-accent transition-colors">{criador.nome}</div>
                            ...
                            <div className="flex flex-row gap-2 mt-4">
                              {criador.redesSociais.twitch && (
                                <a 
                                  ...
                                  className="text-[#9147ff] text-lg hover:scale-110 transition-transform z-10"
                              ...
                              {criador.redesSociais.youtube && (
                                <a 
                                  ...
                                  target="_blank" 
                                  rel="noopener noreferrer" 
                                  className="text-[#ff0000] text-lg hover:scale-110 transition-transform z-10"
                              ...
                              {criador.redesSociais.tiktok && (
                                <a 
                                  ...
                                  target="_blank" 
                                  rel="noopener noreferrer" 
                                  className="text-[#000] text-lg hover:scale-110 transition-transform z-10"
                              ...
                              {criador.redesSociais.instagram && (
                                <a 
                                  ...
                                  target="_blank" 
                                  rel="noopener noreferrer" 
                                  className="text-[#e1306c] text-lg hover:scale-110 transition-transform z-10"
                              ...
                              {criador.redesSociais.discord && (
                                <a 
                                  ...
                                  target="_blank" 
                                  rel="noopener noreferrer" 
                                  className="text-blue-500 text-lg hover:scale-110 transition-transform z-10"
