              ...
              <div>
                ...
                <input 
                  ...
                  onChange={e => {
                    ...
                    setFormConteudo(f => ({ ...f, titulo: tituloTruncado }));
                  }} 
                />
              </div>
                        ...
                        >
                          ...
                          {(() => {
                            ...
                            if (thumbnail && thumbnail.src) {
                              // YouTube, Twitch, Instagram e TikTok com thumbnail real
                              return (
                                    ...
                                    onError={(e) => {
                                      ...
                                      if (parent) {
                                        ...
                                        if (thumbnail.platform === 'Instagram') {
                                          ...
                                          `;
                                        } else if (thumbnail.platform === 'TikTok') {
                                          placeholder.className = 'absolute inset-0 bg-gradient-to-br from-black to-gray-800 flex items-center justify-center text-white';
                                          placeholder.innerHTML = `
                                            <div class="text-center">
